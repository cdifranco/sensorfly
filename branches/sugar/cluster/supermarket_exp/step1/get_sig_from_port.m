...
for anchor_id = 1:base_number
    ...
    msg_array = [uint8(packet_id),uint8('g'),uint8(0),uint8(node_id),uint8(1),uint8(24), typecast(uint16(anchor_id+2),'uint8'), typecast(uint16(0),'uint8'), typecast(uint16(0),'uint8'), typecast(uint16(0),'uint8'), typecast(uint16(0),'uint8'), typecast(single(0.0),'uint8'), typecast(single(0.0),'uint8')];

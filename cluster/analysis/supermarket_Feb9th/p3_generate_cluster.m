...
reading_amount = 141; % size(std_signature, 1); % readings size
...
for mainloop = 1 : reading_amount
    %fprintf('round %d, current point : %d, %d\n',mainloop, current_point(1),current_point(2));

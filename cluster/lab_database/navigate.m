function [succ sig_route error] = navigate(current_point, dest_area, base_number, trans_history, center_sig, count_to_id, matrix, area_cluster_relation, signatures)
%% Initialization
step_threshold = 500;
succ = 1;
error = 0;

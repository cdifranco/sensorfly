...
for j = 1:testing_round
    ...
    [succ sigRoute clusterRoute coordRoute startClus destClus] = navigate([startX, startY], [destX, destY], step_len, b, base_number, trans_history, center, room, coefficient, matrix);
    if succ == 1

...
//RW
// internal use only !!!
  #define NA_TestModes_O                                (0xC)
  #define NA_TestModes_MSB                              (3)
  #define NA_TestModes_LSB                              (0)
  #define NA_TestModes_I                                (0x0)
  #define NA_TestModesOff_C                             (0x0)
  #define NA_TestModesXtal_C                            (0x1)
  #define NA_TestModesFctLo_C                           (0x2)
  #define NA_TestModesDco_C                             (0x3)
  #define NA_TestModesTx_C                              (0x4)
  #define NA_TestModesRx_C                              (0x5)
  #define NA_TestModesBbRamBist_C                       (0x6)
  #define NA_TestModesCsqRamBist_C                      (0x7)
  #define NA_TestModesQuantize_C                        (0x8)
  #define NA_TestModesD3l_C                             (0x9)
  #define NA_TestModesPulseDet_C                        (0xA)
  #define NA_TestModesBat_C                             (0xB)

//------------------------------------------------------------
//RW
// internal use only !!!
  #define NA_RfTestSelect_O                             (0xD)
  #define NA_RfTestSelect_MSB                           (3)
  #define NA_RfTestSelect_LSB                           (0)
  #define NA_RfTestSelect_I                             (0x0)

  #define NA_RfTestSelRxIAdc_C                          (0x0)
  #define NA_RfTestSelRxQAdc_C                          (0x1)

  #define NA_RfTestSelTxDacCmd_C                        (0x0)
  #define NA_RfTestSelTxCsqDacIN_C                      (0x3)
  #define NA_RfTestSelTxCsqDacIP_C                      (0x4)
  #define NA_RfTestSelTxCsqDacQN_C                      (0x5)
  #define NA_RfTestSelTxCsqDacQP_C                      (0x6)
  #define NA_RfTestSelTxVbg_C                           (0x7)
...
// ATTENTION: while all other interrupts in the design are event triggered,
//            the interrupt 'LoTuningNeeded' is state triggered. To handle
//            this interrupt, disable it first, then start the lo tuning
//            and after that (allowed while tuning) reset interrupt
...
//WO
  #define NA_LoEnableRecalib_O                          (0x1C)
  #define NA_LoEnableRecalib_B                          (5)
  #define NA_LoEnableRecalib_I                          (0x0)
...
//WO; TestOnly
  #define NA_AgcEnable_O                                (0x26)
  #define NA_AgcEnable_B                                (7)
  #define NA_AgcEnable_I                                (0x0)
...
//WO; TestOnly
  #define NA_CsqTest_O                                  (0x3D)
  #define NA_CsqTest_B                                  (7)
  #define NA_CsqTest_I                                  (0x0)
...
//WO; TestOnly
  #define NA_D3lFixThres1MapEn_O                        (0x41)
  #define NA_D3lFixThres1MapEn_B                        (7)
  #define NA_D3lFixThres1MapEn_I                        (0x0)
...
//WO; TestOnly
  #define NA_EnableIntPA_O                              (0x42)
  #define NA_EnableIntPA_B                              (5)
  #define NA_EnableIntPA_I                              (0x0)

//WO; TestOnly
  #define NA_EnableRxClock_O                            (0x42)
  #define NA_EnableRxClock_B                            (6)
  #define NA_EnableRxClock_I                            (0x0)

//WO; TestOnly
  #define NA_EnableRx_O                                 (0x42)
  #define NA_EnableRx_B                                 (7)
  #define NA_EnableRx_I                                 (0x0)
...
//WO
  #define NA_RtcTimeBTestMode_O                         (0x62)
  #define NA_RtcTimeBTestMode_B                         (7)
  #define NA_RtcTimeBTestMode_I                         (0x0)
...
//------------------------------------------------------------
//RW
  #define NA_TxRxDigTestMode_O                          (0x7D)
  #define NA_TxRxDigTestMode_B                          (0)
  #define NA_TxRxDigTestMode_I                          (0x0)

//RO
  #define NA_DebugMacRxCmd_O                            (0x7D)
  #define NA_DebugMacRxCmd_B                            (2)
  #define NA_DebugMacRxCmd_I                            (0x0)

  #define NA_DebugMacRxCmdIdle_BC_C                     (0x0)
  #define NA_DebugMacRxCmdActive_BC_C                   (0x1)

//RO
  #define NA_DebugMacTxCmd_O                            (0x7D)
  #define NA_DebugMacTxCmd_B                            (3)
  #define NA_DebugMacTxCmd_I                            (0x0)

  #define NA_DebugMacTxCmdIdle_BC_C                     (0x0)
  #define NA_DebugMacTxCmdActive_BC_C                   (0x1)

//WO
  #define NA_BistBbRamReset_O                           (0x7D)
  #define NA_BistBbRamReset_B                           (4)
  #define NA_BistBbRamReset_I                           (0x1)

//WO
  #define NA_BistBbRamActive_O                          (0x7D)
  #define NA_BistBbRamActive_B                          (5)
  #define NA_BistBbRamActive_I                          (0x0)

//WO
  #define NA_BistCsqRamReset_O                          (0x7D)
  #define NA_BistCsqRamReset_B                          (6)
  #define NA_BistCsqRamReset_I                          (0x1)

//WO
  #define NA_BistCsqRamActive_O                         (0x7D)
  #define NA_BistCsqRamActive_B                         (7)
  #define NA_BistCsqRamActive_I                         (0x0)


//------------------------------------------------------------
//RO
  #define NA_DebugMacFsm_O                              (0x7E)
  #define NA_DebugMacFsm_MSB                            (3)
  #define NA_DebugMacFsm_LSB                            (0)
  #define NA_DebugMacFsm_I                              (0x0)

  #define NA_DebugMacFsmIdle_VC_C                       (0x0)
  #define NA_DebugMacFsmRxIfPacket_VC_C                 (0x1)
  #define NA_DebugMacFsmTxReq2s_VC_C                    (0x2)
  #define NA_DebugMacFsmRxIfClr2s_VC_C                  (0x3)
  #define NA_DebugMacFsmRxClr2sTimeOut_VC_C             (0x4)
  #define NA_DebugMacFsmTxData_VC_C                     (0x5)
  #define NA_DebugMacFsmRxIfAck_VC_C                    (0x6)
  #define NA_DebugMacFsmRxAckTimeOut_VC_C               (0x7)
  #define NA_DebugMacFsmTxClr2s_VC_C                    (0x8)
  #define NA_DebugMacFsmRxData_VC_C                     (0x9)
  #define NA_DebugMacFsmTxAck_VC_C                      (0xA)

//RO
  #define NA_DebugMacTxRxCtrl_O                         (0x7E)
  #define NA_DebugMacTxRxCtrl_MSB                       (7)
  #define NA_DebugMacTxRxCtrl_LSB                       (4)
  #define NA_DebugMacTxRxCtrl_I                         (0x0)

  #define NA_DebugMacTxRxCtrlIdle_VC_C                  (0x0)
  #define NA_DebugMacTxRxCtrlTxRampUp_VC_C              (0x1)
  #define NA_DebugMacTxRxCtrlTx_VC_C                    (0x2)
  #define NA_DebugMacTxRxCtrlTxRampDown_VC_C            (0x3)
  #define NA_DebugMacTxRxCtrlRxRampUp_VC_C              (0x4)
  #define NA_DebugMacTxRxCtrlRxIfSync_VC_C              (0x5)
  #define NA_DebugMacTxRxCtrlRxAbortGo2Tx_VC_C          (0x6)
  #define NA_DebugMacTxRxCtrlRx_VC_C                    (0x7)
  #define NA_DebugMacTxRxCtrlRxAbort_VC_C               (0x8)
  #define NA_DebugMacTxRxCtrlRxRampDown_VC_C            (0x9)

//------------------------------------------------------------
//RO
  #define NA_DebugBitProcFsm_O                          (0x7F)
  #define NA_DebugBitProcFsm_MSB                        (3)
  #define NA_DebugBitProcFsm_LSB                        (0)
  #define NA_DebugBitProcFsm_I                          (0x0)

  #define NA_DebugBitProcFsmIdle_VC_C                   (0x0)
  #define NA_DebugBitProcFsmPreamble_VC_C               (0x1)
  #define NA_DebugBitProcFsmSyncWord_VC_C               (0x2)
  #define NA_DebugBitProcFsmScrambInit_VC_C             (0x3)
  #define NA_DebugBitProcFsmMacCode_VC_C                (0x4)
  #define NA_DebugBitProcFsmAddr1_VC_C                  (0x5)
  #define NA_DebugBitProcFsmAddr2_VC_C                  (0x6)
  #define NA_DebugBitProcFsmLength_VC_C                 (0x7)
  #define NA_DebugBitProcFsmCrc1_VC_C                   (0x8)
  #define NA_DebugBitProcFsmData_VC_C                   (0x9)
  #define NA_DebugBitProcFsmCrc2_VC_C                   (0xA)
  #define NA_DebugBitProcFsmTail_VC_C                   (0xB)

//RO
  #define NA_DebugBitProcTx_O                           (0x7F)
  #define NA_DebugBitProcTx_B                           (4)
  #define NA_DebugBitProcTx_I                           (0x0)

//RO
  #define NA_DebugBitProcRx_O                           (0x7F)
  #define NA_DebugBitProcRx_B                           (5)
  #define NA_DebugBitProcRx_I                           (0x0)

//RO
  #define NA_DebugRxDetStatus_O                         (0x7F)
  #define NA_DebugRxDetStatus_MSB                       (7)
  #define NA_DebugRxDetStatus_LSB                       (6)
  #define NA_DebugRxDetStatus_I                         (0x0)

  #define NA_DebugRxDetStatusIdle_VC_C                  (0x0)
  #define NA_DebugRxDetStatusUnSync_VC_C                (0x1)
  #define NA_DebugRxDetStatusBitSync_VC_C               (0x2)
  #define NA_DebugRxDetStatusFrameSync_VC_C             (0x3)

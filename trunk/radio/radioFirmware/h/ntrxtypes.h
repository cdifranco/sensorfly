...
typedef struct
{
	...
	MyByte8T attribute;
//#	ifdef CONFIG_NTRX_SNIFFER // Sensorfly note: We aren't in "sniffer" mode, but we want to support a broadcast address, so we need to have rxAddr in the message struct.
